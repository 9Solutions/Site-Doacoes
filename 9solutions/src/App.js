...
import listaCampo from "./component/listaCampo.component"

function App() {
  function mascaraCPF(cpf) {
    return cpf.replace(/\D/g, '0').replace(/(\d{3})(\d{3})(\d{3})(\d{2})/, '$1.$2.$3-$4');
  }
  function handleCpfKeyUp(refName, e){
    console.log(refName);
    console.log(e);
  }
  return (
            ...
            <div className="container-fluid">
              ...
              >
                ...
                >
                  ...
                  <input id= "cpf" type="text" placeholder = "000.000.000-00" style={{ height: 30, width: 205 }} />

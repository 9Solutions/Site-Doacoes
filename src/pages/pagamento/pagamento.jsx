        ...
        <div className={styles["div-pagamento"]}>
          <div className={styles["barra"]}>
            ...
            <p
                ...
                className={activeTab === 'Pagamento' ? styles["active"] : ""}
            >
              Pagamento
            </p>
            <p
                onClick={() => handleNavigationClick('Finalização')}
                className={activeTab === 'Finalização' ? styles["active"] : ""}
            >
              Finalização
            </p>
          </div>
          ...
          <div style={{padding: "24px 48px", display: activeTab !== 'Pagamento' ? 'none' : '', minHeight: "50vh"}}>
                                ...
                                {selectedOption === "pix2" && (
                                    <div className={styles["div-pagamento-pix-2"]}>
                                      ...
                                      <input
                                          ...
                                          ref={emailRef}
                                      />
                                      <Button className={styles["ok-button"]} title={"Copiar Código"}></Button>
            ...
            {activeTab === 'Pagamento' && !Object.values(showLabel).every(value => value === false) && (
                <div className={styles["buttons"]}>
                  <Button className={styles["cancel-button"]} title={"Cancelar"}></Button>
          ...
          {activeTab === 'Finalização' && (
              <div className={styles["container-finalizacao"]}>
                ...
                <div className={styles["buttons"]}>
                  <Button onClick={() => navigate("/acompanhamento")} title={"Acompanhar"}>
                  </Button>
                </div>
              </div>
